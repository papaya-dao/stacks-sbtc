...
(define-constant err-not-debug-controller (err u900)) ;; The caller is not a debug controller.
(define-constant err-no-transactions (err u901)) ;; No transactions to simulate mining a block with.
