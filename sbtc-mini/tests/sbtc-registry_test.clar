...
(define-constant err-peg-wallet-already-set (err u2602))
(define-constant err-minimum-burnchain-confirmations-not-reached (err u2603))
(define-constant err-not-settled-state (err u2604))
(define-constant err-invalid-txid-length (err u2605))
(define-constant err-unknown-peg-out-request (err u2606))
(define-constant err-peg-out-not-pending (err u2607))
