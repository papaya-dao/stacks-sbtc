...
(define-public (test-pre-register)
	(begin
		(unwrap! (contract-call? .pox-3 allow-contract-caller .sbtc-stacking-pool) (err u1))
		;; @mine-empty 70200
		(unwrap! (contract-call? .sbtc-stacking-pool signer-pre-register u100000000000) (err u2))
		;; (unwrap!
