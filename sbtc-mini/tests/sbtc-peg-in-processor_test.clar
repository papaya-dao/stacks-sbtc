(define-constant err-burn-tx-already-processed (err u2600))

(define-constant err-peg-in-expired (err u4500))
(define-constant err-not-a-peg-wallet (err u4501))
(define-constant err-invalid-spending-pubkey (err u4503))
(define-constant err-peg-value-not-found (err u4505))
(define-constant err-missing-witness (err u4506))
(define-constant err-unlock-script-not-found-or-invalid (err u4507))

(define-constant err-script-invalid-opcode (err u4510))
(define-constant err-script-invalid-version (err u4511))
(define-constant err-script-not-op-drop (err u4512))
(define-constant err-script-checksig-missing (err u4513))
(define-constant err-script-missing-pubkey (err u4514))
(define-constant err-script-invalid-principal (err u4515))
(define-constant err-script-invalid-length (err u4516))
